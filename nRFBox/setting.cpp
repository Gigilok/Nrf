...
#include "icon.h"
#include "config.h"
#include <U8g2lib.h>          // Necessário para o objeto u8g2
#include <Adafruit_NeoPixel.h> // Necessário para o objeto pixels

// --- Rádios (Já estavam aqui) ---
RF24 RadioA(NRF_CE_PIN_A, NRF_CSN_PIN_A);
RF24 RadioB(NRF_CE_PIN_B, NRF_CSN_PIN_B);
RF24 RadioC(NRF_CE_PIN_C, NRF_CSN_PIN_C);

// --- Definição única das variáveis (SEM 'extern' aqui) ---
// Note que o pino 14 é o que definimos para o NeoPixel
